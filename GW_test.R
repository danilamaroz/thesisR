...
# dim = model, variable, h-step ahead, quantity of rolling windows, 30
T = nrow(data0)
m = ncol(data0)
...
fitted.errs <- array(0, dim = c(5, 3, 8, T-40, 30), dimnames = c(modelnames, dimnames, hnames, data0[41:T, 1], 1:30))
